...
int main() {
   ...
   printf("Iveskite 10 neneigiamu sveikuju skaiciu. Programa pateiks kiekviena unikalia reiksme bei\nju ivedimu kieki didejancia tvarka.\n");
   ...
   printf("Duomenys sekmingai pateikti\n");
